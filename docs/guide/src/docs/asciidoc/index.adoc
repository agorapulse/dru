...
dependencies {
    ...
    testCompile "com.agorapulse:dru:{project-version}"

    // and pick any client
    testCompile "com.agorapulse:dru-client-dynamodb:{project-version}"
    testCompile "com.agorapulse:dru-client-gorm:{project-version}"
    testCompile "com.agorapulse:dru-client-micronaut-data:{project-version}"

    // and pick any parser
    testCompile "com.agorapulse:dru-parser-json:{project-version}"
    testCompile "com.agorapulse:dru-parser-yaml:{project-version}"
}
----
