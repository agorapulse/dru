...
----
include::../examples/dru-example-avl/src/test/groovy/avl/ItemSpec.groovy[]
----
...
.item.json
----
include::../examples/dru-example-avl/src/test/resources/avl/ItemSpec/item.json[]
----
...
.Complex Path
----
include::../examples/dru-example-avl/src/test/groovy/avl/ItemsPathSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.items.json
----
include::../examples/dru-example-avl/src/test/resources/avl/ItemsPathSpec/items.json[]
----
...
.Default Value
----
include::../examples/dru-example-avl/src/test/groovy/avl/DefaultValueSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.item.json
----
include::../examples/dru-example-avl/src/test/resources/avl/DefaultValueSpec/item.json[]
----
...
.Overriding Properties
----
include::../examples/dru-example-avl/src/test/groovy/avl/OverrideValueSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.item.json
----
include::../examples/dru-example-avl/src/test/resources/avl/OverrideValueSpec/item.json[]
----
...
.Aliasing Properties
----
include::../examples/dru-example-avl/src/test/groovy/avl/AliasSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.item.json
----
include::../examples/dru-example-avl/src/test/resources/avl/AliasSpec/item.json[]
----
...
.Ignoring Properties
----
include::../examples/dru-example-avl/src/test/groovy/avl/IgnoreSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.item.json
----
include::../examples/dru-example-avl/src/test/resources/avl/IgnoreSpec/item.json[]
----
...
.Conditional Mapping
----
include::../examples/dru-example-avl/src/test/groovy/avl/ConditionalSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.persons.json
----
include::../examples/dru-example-avl/src/test/resources/avl/ConditionalSpec/persons.json[]
----
...
.Nested Mapping
----
include::../examples/dru-example-avl/src/test/groovy/avl/NestedSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.agents.json
----
include::../examples/dru-example-avl/src/test/resources/avl/NestedSpec/agents.json[]
----
...
.Top Level Mapping
----
include::../examples/dru-example-avl/src/test/groovy/avl/NestedSpec.groovy[tag="reuse"]
----
...
.Partial Retrieval
----
include::../examples/dru-example-avl/src/test/groovy/avl/JustSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.missionLogEntry.json
----
include::../examples/dru-example-avl/src/test/resources/avl/JustSpec/missionLogEntry.json[]
----
...
.Agents Data Set
----
include::../examples/dru-example-avl/src/test/groovy/avl/AgentsDataSet.groovy[]
----
...
.Using Data Set
----
include::../examples/dru-example-avl/src/test/groovy/avl/DataSetSpec.groovy[tag="plan"]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/ListenersSpec.groovy[tag="plan"]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/ReflectionSpec.groovy[tag="plan"]
----
...
.Using YAML Parser
----
include::../examples/dru-example-avl/src/test/groovy/avl/YamlSpec.groovy[tag="plan"]
----

[source,yml,indent=0,options="nowrap"]
.agents.yml
----
include::../examples/dru-example-avl/src/test/resources/avl/YamlSpec/agents.yml[]
----
...
.Using POJO Client
----
include::../examples/dru-example-avl/src/test/groovy/avl/PojoSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.library.json
----
include::../examples/dru-example-avl/src/test/resources/avl/PojoSpec/library.json[]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.library.json
----
include::../examples/dru-example-avl/src/test/resources/avl/DynamoDBSampleSpec/missionLogEntry.json[]
----

[source,indent=0,options="nowrap"]
.MissionLogEntry.groovy
----
include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="header"]

include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="hashKeyAnno"]
include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="hashKey"]

include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="properties"]

include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="ext"]
include::../examples/dru-example-avl/src/main/groovy/avl/MissionLogEntry.groovy[tag="footer"]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="mapper"]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="grailsService"]
----
...
----
include::../examples/dru-example-avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="advancedMapper"]
----
...
.Failing Batch Items
----
include::../examples/dru-example-avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="batchWriteFailed"]
----
...
.Using GORM Client
----
include::../examples/dru-example-avl/src/test/groovy/avl/GormSpec.groovy[tag="plan"]
----

[source,json,indent=0,options="nowrap"]
.agents.json
----
include::../examples/dru-example-avl/src/test/resources/avl/GormSpec/agents.json[]
----
...
.Agent.groovy
----
include::../examples/dru-example-avl/grails-app/domain/avl/Agent.groovy[tag="header"]
include::../examples/dru-example-avl/grails-app/domain/avl/Agent.groovy[tag="properties"]
include::../examples/dru-example-avl/grails-app/domain/avl/Agent.groovy[tag="footer"]
----
...
----
include::../examples/dru-example-avl/src/integration-test/groovy/avl/GormIntegrationSpec.groovy[tag="plan"]
----
