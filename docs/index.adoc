...
----
include::../examples/avl/src/test/groovy/avl/ListenersSpec.groovy[tag="plan"]
----
...
.Failing Batch Items
----
include::../examples/avl/src/test/groovy/avl/DynamoDBSampleSpec.groovy[tag="batchWriteFailed"]
----
...
----
include::../examples/avl/src/integration-test/groovy/avl/GormIntegrationSpec.groovy[tag="plan"]
----
